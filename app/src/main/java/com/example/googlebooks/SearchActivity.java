        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.isEmpty() && author.isEmpty() && publisher.isEmpty() && isbn.isEmpty()){
                    String message = getString(R.string.no_search);
                    ...
                    //Toast.makeText(getApplicationContext(), "l'intent donne ceci" +  intent.getStringExtra("Query"), Toast.LENGTH_SHORT).show();
